                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    additionalInfoTopic = string.IsNullOrWhiteSpace(additionalInfoTopic) ? "---" : additionalInfoTopic;
                                    ...
                                    $" (N'{firstName}', N'{lastName}', N'{password}', N'{phoneNumber}', N'{email}', N'{subject}', N'{escapedMessage}', {feedbackRating}, N'{usefulTopic}', N'{additionalInfoTopic}', {websiteSatisfaction}, 0)";
