            ...
            <form action="contact.aspx" method="post" onsubmit="return check();">
                ...
                <div class="feedback">
                    <details style="border-bottom: 2px solid white;">
                        ...
                        <input  type="checkbox" id="Starting out-op" name="improve" value="Starting-out" <%= (Session["AdditionalInfoTopic"] != null && Session["AdditionalInfoTopic"].ToString().Contains("Starting-out")) ? "checked" : "" %>>
                        <label for="Starting-out">Starting out</label><br>
                        <input  type="checkbox" id="css-op" name="improve" value="Building" <%= (Session["AdditionalInfoTopic"] != null && Session["AdditionalInfoTopic"].ToString().Contains("Building")) ? "checked" : "" %>>
                        <label for="Building">Building</label><br>
                        <input  type="checkbox" id="Betaflight-op" name="improve" value="Betaflight" <%=  (Session["AdditionalInfoTopic"] != null && Session["AdditionalInfoTopic"].ToString().Contains("Betaflight")) ? "checked" : "" %>>
                        <label for="Betaflight" >Betaflight</label>
